...
<?php
$devQuery = "SELECT babydev, mumsdev FROM pregnancy_by_week" ;
...
<body>
	...
	<?php 
	if ($term->num_rows > 0) {
		echo "<table class='table table-bordered'><tr><th>Baby's Development</th></tr>";
			$row = $term->fetch_assoc();
			echo "<tr><td>". $row['babydev'] . "</td></tr>";
			echo "<tr><th>Mum's Development</th><tr>";
