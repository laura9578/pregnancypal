...
CREATE TABLE `food_warning_table` (
  ...
  `timesSearched` int(150) NOT NULL
...
INSERT INTO `food_warning_table` (`id`, `user_id`, `food`, `foodWarning`, `timesSearched`) VALUES
(1, 0, 'Uncooked Seafood', 'Uncooked seafood is a food that has a risk of infection, and may carry coliform bacteria, salmonella, toxoplasmosis, and other dangerous bacteria. A baby\'s immune system isn\'t fully formed and these serious infections can be deadly.', 0),
(2, 0, 'Fish and Mercury', 'These foods carry a risk of toxins. \r\nBabies don\'t have the ability to clear mercury out of their systems. In addition, developing brains are believed to be particularly vulnerable to mercury. Consuming mercury during pregnancy may cause brain damage and developmental delays.\r\n\r\nFish high in mercury include tilefish, swordfish, king mackerel, and shark.', 0);
